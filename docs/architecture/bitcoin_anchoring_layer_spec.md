...
struct AmbientAIAnchoringEpoch {
    ...
    Hash256 energyLedgerRoot;       // Merkle root of all node energy balances
    Hash256 participationRoot;      // Merkle root of deterministic node participation proofs
    Hash256 ambientEventRoot;       // Merkle root of the Ambient Internet extension event tree
